...
#         
#     cv2.imwrite('/Users/nguyenviet/Desktop/CnnDigitRecognize-2/temp/pic1.jpg',input_img)
#     print("test")
# =============================================================================
...
# =============================================================================
    ...
    for y in lines_y1:
        cv2.line(input_img, (y[0],y[1]), (y[2], y[3]), (0,0,255), 1)
    if typeS == 1:
        cv2.imwrite('/Users/nguyenviet/Desktop/CnnDigitRecognize-2/temp/pic2.jpg',input_img)
    if typeS == 2:
        cv2.imwrite('/Users/nguyenviet/Desktop/CnnDigitRecognize-2/temp/pic1.jpg',input_img)
    if typeS == 3:
        cv2.imwrite('/Users/nguyenviet/Desktop/CnnDigitRecognize-2/temp/pic3.jpg',input_img)
    #cv2.imwrite('/Users/nguyenviet/Desktop/CnnDigitRecognize-2/temp/pic1.jpg',input_img)
